    ...
    <div className="list-container">
      <div className="list-header">
        <div className="list-header-left">
          <h2>Reasearch Docs</h2>
          <p>Dissertation Theses, Selected Papers & UG Reports</p>
        </div>
        <input
          type="text"
          placeholder="Search..."
...
export async function getServerSideProps(context) {
  let data = await fetch(
    directusURLSSR +
      "/items/documents?fields=*,uploadedBy.*,document.*,limit=-1&filter[docType][_eq]=research"
  );
